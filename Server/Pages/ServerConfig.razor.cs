...
namespace SODesk.Server.Pages
{
    ...
    public partial class ServerConfig : AuthComponentBase
    {
        ...
        private readonly List<SODeskUser> _userList = new();
        ...
        private IEnumerable<SODeskUser> UserList
        {
            get
            {
        ...
        private async Task SaveAndTestSmtpSettings()
        {
            ...
            var success = await EmailSender.SendEmailAsync(User.Email, "SODesk Test Email", "Congratulations! Your SMTP settings are working!", User.OrganizationID);
            if (success)
            {
        ...
        private void SetIsServerAdmin(ChangeEventArgs ev, SODeskUser user)
        {
