...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeviceGroupSODeskUser", b =>
                {
                    ...
                    b.ToTable("DeviceGroupSODeskUser");
                });
            ...
            modelBuilder.Entity("SODesk.Shared.Models.Alert", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SODesk.Shared.Models.ApiToken", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SODesk.Shared.Models.BrandingInfo", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SODesk.Shared.Models.Device", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SODesk.Shared.Models.DeviceGroup", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SODesk.Shared.Models.EventLog", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SODesk.Shared.Models.InviteLink", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SODesk.Shared.Models.Organization", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SODesk.Shared.Models.SavedScript", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SODesk.Shared.Models.ScriptResult", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SODesk.Shared.Models.ScriptRun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SODesk.Shared.Models.ScriptSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SODesk.Shared.Models.SharedFile", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SODesk.Shared.Models.SODeskUser", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("SODeskUser");
                });

            modelBuilder.Entity("DeviceGroupSODeskUser", b =>
                {
                    b.HasOne("SODesk.Shared.Models.DeviceGroup", null)
                        .WithMany()
                        .HasForeignKey("DeviceGroupsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SODesk.Shared.Models.SODeskUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DeviceGroupScriptSchedule", b =>
                {
                    ...
                    b.HasOne("SODesk.Shared.Models.ScriptSchedule", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DeviceScriptRun", b =>
                {
                    b.HasOne("SODesk.Shared.Models.Device", null)
                        .WithMany()
                        .HasForeignKey("DevicesID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SODesk.Shared.Models.ScriptRun", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SODesk.Shared.Models.Alert", b =>
                {
                    b.HasOne("SODesk.Shared.Models.Device", "Device")
                        .WithMany("Alerts")
                        .HasForeignKey("DeviceID");

                    b.HasOne("SODesk.Shared.Models.Organization", "Organization")
                        .WithMany("Alerts")
                        .HasForeignKey("OrganizationID");

                    b.HasOne("SODesk.Shared.Models.SODeskUser", "User")
                        .WithMany("Alerts")
                        .HasForeignKey("UserID");
            ...
            modelBuilder.Entity("SODesk.Shared.Models.Device", b =>
                {
                    b.HasOne("SODesk.Shared.Models.DeviceGroup", "DeviceGroup")
                        .WithMany("Devices")
            ...
            modelBuilder.Entity("SODesk.Shared.Models.Organization", b =>
                {
                    b.HasOne("SODesk.Shared.Models.BrandingInfo", "BrandingInfo")
                        .WithMany()
            ...
            modelBuilder.Entity("SODesk.Shared.Models.SavedScript", b =>
                {
                    b.HasOne("SODesk.Shared.Models.SODeskUser", "Creator")
            ...
            modelBuilder.Entity("SODesk.Shared.Models.ScriptResult", b =>
                {
                    ...
                    b.HasOne("SODesk.Shared.Models.ScriptSchedule", "Schedule")
                        .WithMany()
